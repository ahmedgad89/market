...
public class Customer extends javax.swing.JDialog {
    ...
    private void Update_table() {
        ...
        try {
            ...
            String sql = "select id,customer_name,customer_location,customer_phone1,customer_phone2,user_save,date_save from customer";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            table.setModel(DbUtils.resultSetToTableModel(rs));
            String[] tableColumnsName = {"*", "إسم العميل", "المحلية", "الهاتف1", "الهاتف2", "حفظ بواسطة", "تاريخ الحفظ"};
    ...
    private void initComponents() {
        ...
        txt_customer_phone2 = new javax.swing.JTextField();
        txt_customer_note = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        jLabel12 = new javax.swing.JLabel();
        txt_customer_name = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        txt_customer_location = new javax.swing.JComboBox<>();
        txt_customer_adrr = new javax.swing.JTextField();
        ...
        setTitle("إدارة الإسماء العلمية");
        ...
        bt_new.setForeground(new java.awt.Color(26, 188, 156));
        bt_new.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Add_New_24px_2.png"))); // NOI18N
        bt_new.setText("جديد");
        ...
        bt_save.setForeground(new java.awt.Color(26, 188, 156));
        bt_save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Add_File_24px_2.png"))); // NOI18N
        bt_save.setText("حفظ");
        ...
        bt_update.setForeground(new java.awt.Color(26, 188, 156));
        bt_update.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Edit_24px_2.png"))); // NOI18N
        ...
        bt_delete.setForeground(new java.awt.Color(26, 188, 156));
        bt_delete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Delete_24px_2.png"))); // NOI18N
        ...
        jScrollPane4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(26, 188, 156)));
        ...
        table.setForeground(new java.awt.Color(26, 188, 156));
        ...
        table.setSelectionBackground(new java.awt.Color(26, 188, 156));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Search_24px_2.png"))); // NOI18N
        ...
        jLabel15.setText("هاتف العميل 2");

        txt_customer_phone1.setBackground(new java.awt.Color(240, 240, 240));
        txt_customer_phone1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_phone1.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_customer_phone1.setText("-");
        txt_customer_phone1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("هاتف العميل 1");

        txt_customer_phone2.setBackground(new java.awt.Color(240, 240, 240));
        txt_customer_phone2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_phone2.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_customer_phone2.setText("-");
        txt_customer_phone2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));

        txt_customer_note.setBackground(new java.awt.Color(240, 240, 240));
        txt_customer_note.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_note.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_customer_note.setText("-");
        txt_customer_note.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));
        ...
        jLabel12.setText("إسم العميل");

        txt_customer_name.setBackground(new java.awt.Color(240, 240, 240));
        txt_customer_name.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_name.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_customer_name.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));

        jLabel16.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("عنوان العميل");

        txt_customer_location.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_location.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "الخرطوم", "جبل أولياء", "امدرمان", "كرري", "أمبدة", "بحري", "شرق النيل" }));
        txt_customer_location.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));
        txt_customer_location.setPreferredSize(new java.awt.Dimension(6, 28));
        txt_customer_location.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txt_customer_locationMouseClicked(evt);
            }
        });
        txt_customer_location.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_customer_locationActionPerformed(evt);
            }
        });

        txt_customer_adrr.setBackground(new java.awt.Color(240, 240, 240));
        txt_customer_adrr.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_customer_adrr.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_customer_adrr.setText("-");
        txt_customer_adrr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_customer_phone2, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txt_customer_name, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(txt_customer_adrr)
                                        .addGap(2, 2, 2)
                                        .addComponent(txt_customer_location, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addComponent(txt_customer_note, javax.swing.GroupLayout.PREFERRED_SIZE, 607, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel13, jLabel15});
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(txt_customer_phone1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12)
                    .addComponent(jLabel13)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(txt_customer_location, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15)
                    .addComponent(txt_customer_phone2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_customer_adrr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel16))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel17)
                    .addComponent(txt_customer_note, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txt_customer_adrr, txt_customer_name, txt_customer_note, txt_customer_phone1, txt_customer_phone2});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel13, jLabel15});
        ...
        jLabel14.setText("إدارة العملاء");
    ...
    private void bt_newActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_newActionPerformed
        ...
        txt_customer_location.setSelectedIndex(0);
        txt_customer_adrr.setText("-");
    ...
    private void bt_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_saveActionPerformed
        try {
            ...
            String sql22 = " select * from customer where customer_name= '" + txt_customer_name.getText() + "'";
            pst = conn.prepareStatement(sql22);
            rs = pst.executeQuery();
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "إسم العميل " + txt_customer_name.getText() + " مسجل مسبقاً", "لا يمكن الحفظ", JOptionPane.OK_OPTION);
                return;
            }
        ...
        if ((txt_customer_name.getText().matches("")) || (txt_customer_name.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "قم بإدخال إسم العميل للحفظ !");
            return;
        } else if ((txt_customer_phone1.getText().matches("")) || (txt_customer_phone1.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "قم بإدخال هاتف العميل للحفظ !");
            return;
        } else {

            int Ahmed = JOptionPane.showConfirmDialog(null, "هل تريد حقا حفظ " + txt_customer_name.getText(), "حفظ بيانات", JOptionPane.YES_NO_OPTION);
            if (Ahmed == 0) {
                ...
                try {
                    ...
                    String sql = "insert into customer "
                            + "(customer_name,customer_location,customer_adrr,customer_phone1,customer_phone2,customer_note,user_save,date_save)" + " values (?,?,?,?,?,?,?,?)";

                    pst = conn.prepareStatement(sql);
                    pst.setString(1, txt_customer_name.getText());
                    pst.setString(2, txt_customer_location.getSelectedItem().toString());
                    pst.setString(3, txt_customer_adrr.getText());
                    pst.setString(4, txt_customer_phone1.getText());
                    pst.setString(5, txt_customer_phone2.getText());
                    pst.setString(6, txt_customer_note.getText());
                    ...
                    pst.execute();
                    Update_table();
                    String add2 = txt_customer_name.getText();
                    txt_customer_name.setText("");
                    txt_customer_location.setSelectedIndex(0);
                    txt_customer_adrr.setText("-");
    ...
    private void bt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_updateActionPerformed
        try {
            ...
            String sql1 = "select * from customer where customer_name ='" + txt_customer_name.getText() + "' AND id !='" + AA5 + "'";
            pst = conn.prepareStatement(sql1);
            rs = pst.executeQuery();
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, " تم تسجيل " + txt_customer_name.getText() + " من قبل ", "لا يمكن الحفظ", JOptionPane.OK_OPTION);
                return;
            }
        ...
        if ((txt_customer_phone1.getText().matches("")) || (txt_customer_phone1.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "قم بإدخال هاتف العميل للتعديل !");
            return;
        ...
        if (Ahmed == 0) {
            ...
            try {
                String add1 = txt_customer_name.getText();
                String add2 = txt_customer_location.getSelectedItem().toString();
                String add3 = txt_customer_adrr.getText();
                String add4 = txt_customer_phone1.getText();
                String add5 = txt_customer_phone2.getText();
                String add6 = txt_customer_note.getText();
                String add7 = "Ahmed";
                ...
                String sql = "update  customer set  customer_name = '" + add1 + "',customer_location = '" + add2 + "',customer_adrr = '" + add3 + "',customer_phone1 = '" + add4 + "',customer_phone2 = '" + add5 + "',customer_note = '" + add6 + "',user_save = '" + add7 + "',date_save='" + add8 + "'where id ='" + AA4 + "'";
                pst = conn.prepareStatement(sql);
                pst.execute();
                Update_table();
                bt_save.setEnabled(true);
    ...
    private void bt_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_deleteActionPerformed
        int Ahmed = JOptionPane.showConfirmDialog(null, "هل تريد حذف  " + txt_customer_name.getText(), "حذف بيانات", JOptionPane.YES_NO_OPTION);
        if (Ahmed == 0) {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        try {
            ...
            if (rs.next()) {
                ...
                txt_customer_name.setText(add1);
                String add2 = rs.getString("customer_location");
                txt_customer_location.setSelectedItem(add2);
                String add3 = rs.getString("customer_adrr");
                txt_customer_adrr.setText(add3);

                String add5 = rs.getString("customer_phone2");
                txt_customer_phone2.setText(add5);
                String add6 = rs.getString("customer_note");
                txt_customer_note.setText(add6);

                AA4 = rs.getString("id");
                AA5 = rs.getString("id");

                A4 = txt_customer_name.getText();
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        if (txt_search.getText().isEmpty()) {
            ...
            try {
                ...
                String sql = " select * from customer where customer_name like '" + txt_search.getText() + "%' or customer_location like '" + txt_search.getText() + "%' or customer_phone1 like '" + txt_search.getText() + "%' or customer_phone2 like '" + txt_search.getText() + "%'";
                table.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                bt_save.setEnabled(false);
            ...
            try {
                ...
                String sql11 = " select id,customer_name,customer_location,customer_phone1,customer_phone2,user_save,date_save from customer where customer_name like '" + txt_search.getText() + "%' or customer_location like '" + txt_search.getText() + "%' or customer_phone1 like '" + txt_search.getText() + "%' or customer_phone2 like '" + txt_search.getText() + "%'";
    ...
    private void txt_customer_locationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_customer_locationMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_customer_locationMouseClicked

    private void txt_customer_locationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_customer_locationActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_customer_locationActionPerformed
    ...
    private javax.swing.JTextField txt_customer_adrr;
    private javax.swing.JComboBox<String> txt_customer_location;
    private javax.swing.JTextField txt_customer_name;
    private javax.swing.JTextField txt_customer_note;
    private javax.swing.JTextField txt_customer_phone1;
    private javax.swing.JTextField txt_customer_phone2;
