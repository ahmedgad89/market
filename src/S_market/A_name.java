 ...
 * @author A7meD3H
 */
public class A_name extends javax.swing.JDialog {
...
if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
            String sql = "select id,name,description,user_save,date_save from a_name";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            table.setModel(DbUtils.resultSetToTableModel(rs));

            String[] tableColumnsName = {"*", "المادة الفعالة", "الوصف", "حفظ بواسطة", "تاريخ الحفظ"};
            ...
            header.setBackground(new java.awt.Color(198, 134, 50));
    ...
    private void initComponents() {
        ...
        setTitle("إدارة المواد الفعالة");
        setFocusCycleRoot(false);
        setUndecorated(true);
        setResizable(false);

        jPanel3.setBackground(new java.awt.Color(198, 134, 50));
        ...
        jPanel2.setBackground(new java.awt.Color(198, 134, 50));
        ...
        bt_new.setForeground(new java.awt.Color(198, 134, 50));
        ...
        bt_save.setForeground(new java.awt.Color(198, 134, 50));
        bt_save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Add_File_24px_1.png"))); // NOI18N
        bt_save.setText("حفظ");
        ...
        bt_update.setForeground(new java.awt.Color(198, 134, 50));
        bt_update.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Edit_24px_1.png"))); // NOI18N
        ...
        bt_delete.setForeground(new java.awt.Color(198, 134, 50));
        ...
        txt_name.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));

        jScrollPane4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(198, 134, 50)));
        ...
        table.setForeground(new java.awt.Color(198, 134, 50));
        ...
        table.setSelectionBackground(new java.awt.Color(198, 134, 50));
        ...
        jLabel12.setText("إسم المادة الفعالة");

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("الوصف");

        txt_description.setBackground(new java.awt.Color(240, 240, 240));
        txt_description.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txt_description.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txt_description.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240), 2));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(txt_description, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        jPanel6.setBackground(new java.awt.Color(198, 134, 50));
        ...
        jLabel14.setText("إدارة المواد الفعالة");
    ...
    private void bt_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_saveActionPerformed
        try {
                if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
            String sql22 = " select * from a_name where name= '" + txt_name.getText() + "'";
            pst = conn.prepareStatement(sql22);
            rs = pst.executeQuery();
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "إسم المادة  " + txt_name.getText() + " مسجل مسبقاً", "لا يمكن الحفظ", JOptionPane.OK_OPTION);
                return;
            }
        ...
        if ((txt_name.getText().matches("")) || (txt_name.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "قم بإدخال المادة الفعالة للحفظ !");
        } else {
            ...
            if (Ahmed == 0) {
                try {
                    if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
                    String sql = "insert into a_name "
                            + "(name,description,user_save,date_save)" + " values (?,?,?,?)";
                    pst = conn.prepareStatement(sql);
    ...
    private void bt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_updateActionPerformed
        try {
            if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
            String sql1 = "select * from a_name where name ='" + txt_name.getText() + "' AND id !='" + AA5 + "'";
            pst = conn.prepareStatement(sql1);
            rs = pst.executeQuery();
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, " تم تسجيل " + txt_name.getText() + " من قبل ", "لا يمكن الحفظ", JOptionPane.OK_OPTION);
                return;
            }
        ...
        if ((txt_name.getText().matches("")) || (txt_name.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "قم بإدخال المادة الفعالة للتعديل !");
            return;
        ...
        if (Ahmed == 0) {
            ...
            try {
                ...
                String add2 = txt_description.getText();
                String add3 = "Ahmed";
                ...
                if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
                String sql = "update  a_name set  name= '" + add1 + "',description='" + add2 + "',user_save='" + add3 + "',date_save='" + add4 + "'where id ='" + AA4 + "'";
                pst = conn.prepareStatement(sql);
                pst.execute();
                Update_table();
    ...
    private void bt_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_deleteActionPerformed
        ...
        if (Ahmed == 0) {
            ...
            try {
                if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
                String sql = "delete from a_name where id= ?";
                pst = conn.prepareStatement(sql);
                pst.setString(1, AA4);
                pst.execute();
                Update_table();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        try {
            ...
            if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
            String sql = "select * from a_name where id=?";
            pst = conn.prepareStatement(sql);
            ...
            Logger.getLogger(A_name.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        if (txt_search.getText().isEmpty()) {
            ...
            try {
                if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
                String sql = " select * from a_name where name like '" + txt_search.getText() + "%'";
                table.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                bt_save.setEnabled(false);
            ...
            try {
                if(conn == null  || conn.isClosed() || rs.isClosed() || pst.isClosed()){conn = DB.jave_db();}
                String sql11 = " select id,name,description,user_save,date_save from a_name where name like '" + txt_search.getText() + "%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A_name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new A_name().setVisible(true);
            }
        });
    }
