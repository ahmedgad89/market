 ...
 * @author A7meD3H
 */
public class Producer_Edit extends javax.swing.JDialog {
...
//                pst.setString(1, producer_id);
//                rs = pst.executeQuery();
//                if (rs.next()) {
//                    String add1 = rs.getString("producer_id");
//                    tex_producer_id.setText(add1);
//                    try {
//                        add2 = rs.getBytes("producer_image");
//
//                    } catch (Exception e) {
//                    }
//                    String add3 = rs.getString("producer_name");
//                    tex_producer_name.setText(add3);
//                    String add4 = rs.getString("type_name");
//                    tex_type_name.setText(add4);
//                    String add5 = rs.getString("company_make");
//                    tex_company_make.setText(add5);
//                    String add6 = rs.getString("s_name");
//                    section_name.setSelectedItem(add6);
//                    String add7 = rs.getString("a_name");
//                    type_name1.setSelectedItem(add7);
//                    String add8 = rs.getString("t_name");
//                    group_name.setSelectedItem(add8);
//                    String add9 = rs.getString("ref");
//                    tex_ref.setText(add9);
//                    String add10 = rs.getString("min");
//                    co_min.setSelectedItem(add10);
//                    String add11 = rs.getString("min_buy");
//                    tex_min_buy.setText(add11);
//                    String add12 = rs.getString("min_sale");
//                    tex_min_sale.setText(add12);
//                    String add13 = rs.getString("min_number");
//                    tex_min_number.setText(add13);
//                    String add14 = rs.getString("max");
//                    co_max.setSelectedItem(add14);
//                    String add15 = rs.getString("max_buy");
//                    tex_max_buy.setText(add15);
//                    String add16 = rs.getString("max_sale");
//                    tex_max_sale.setText(add16);
//                    String add17 = rs.getString("max_number");
//                    tex_max_number.setText(add17);
//                    String add22 = rs.getString("producer_note");
//                    tex_producer_note.setText(add22);
//
//                }
//            } catch (SQLException ex) {
//                Logger.getLogger(Producer_Edit.class.getName()).log(Level.SEVERE, null, ex);
//            } finally {
//                try {
//                    rs.close();
//                    pst.close();
...
//        }
    ...
    Producer_Edit(String producer_id) {
        ...
        if (producer_id != null) {
            try {
                ...
                if (rs.next()) {
                    ...
                    try {
                        add2 = rs.getBytes("producer_image");
                        // ImageIcon imageIcon = new ImageIcon(new ImageIcon(add2).getImage().getScaledInstance(tex_producer_image.getWidth(), tex_producer_image.getHeight(), Image.SCALE_DEFAULT));
                    ...
                    String add5 = rs.getString("company_make");
                    tex_company_make.setText(add5);
                    String c_m = rs.getString("country_make");
                    tex_country_make.setText(c_m);
                    String add6 = rs.getString("group_name");
                    group_name.setSelectedItem(add6);
                    String add8 = rs.getString("section_name");
                    section_name.setSelectedItem(add8);
                    String add7 = rs.getString("type_name1");
                    type_name1.setSelectedItem(add7);
                    String add9 = rs.getString("ref");
                    tex_ref.setText(add9);
                    String add10 = rs.getString("min");
                    ...
                    String add22 = rs.getString("producer_note");
                    tex_producer_note.setText(add22);
                    String add23 = rs.getString("alarm_number");
                    tex_alarm_number.setText(add23);
                    //String add24 = rs.getString("in_country");
                    //tex_country_make.setText(add23);
                    String add25 = rs.getString("alarm_date");
                    tex_alarm_date.setText(add25);
    ...
    private void Update_Section(String class_name) {

        try {
            if (conn == null || conn.isClosed() || rs.isClosed() || pst.isClosed()) {
                conn = DB.jave_db();
            }
            String sql = "select * from tb_section where group_name = '" + class_name + "'";
    ...
    private void initComponents() {
        ...
        setTitle("تعديل بيانات المنتجات");
        ...
        tex_country_make.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tex_country_makeActionPerformed(evt);
            }
        });
        ...
        tex_alarm_number.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tex_alarm_numberActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    .addComponent(tex_ref, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(tex_country_make, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addComponent(tex_alarm_date, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addComponent(tex_min_number, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(tex_max_number, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(type_name1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                    .addComponent(tex_alarm_number, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(jLabel35)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(tex_min_sale, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(jLabel34)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(tex_max_sale, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addComponent(tex_producer_name))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(section_name, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jLabel20))
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(tex_max_buy, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jLabel17)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(bt_add_t1, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(0, 0, 0)
                                                .addComponent(co_max, 0, 130, Short.MAX_VALUE))
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(tex_min_buy, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jLabel28)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(bt_add_t2, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(0, 0, 0)
                                                .addComponent(co_min, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, 0)
                                .addComponent(group_name, 0, 130, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {co_max, co_min, group_name, section_name, tex_max_buy, tex_min_buy});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel11, jLabel16, jLabel20, jLabel26, jLabel27, jLabel33});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel17, jLabel28, jLabel9});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel10, jLabel8});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel18, jLabel29, jLabel30});
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jLabel14)
                    .addComponent(tex_country_make, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(tex_ref, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel27)
                    .addComponent(co_max, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel17)
                    .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel34)
                    .addComponent(bt_add_t1, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_max_number, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_max_sale, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_max_buy, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel26)
                    .addComponent(co_min, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel28)
                    .addComponent(jLabel30, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel35)
                    .addComponent(bt_add_t2, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_min_number, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_min_sale, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tex_min_buy, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel33)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(jLabel12)
                            .addComponent(tex_alarm_number, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel13)
                            .addComponent(tex_alarm_date, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(15, 15, 15))
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel10, jLabel11, jLabel16, jLabel17, jLabel20, jLabel26, jLabel27, jLabel28, jLabel33, jLabel8, jLabel9});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {co_max, co_min, group_name, section_name, tex_max_buy, tex_max_number, tex_max_sale, tex_min_buy, tex_min_number, tex_min_sale, tex_ref, type_name1});
        ...
        jLabel21.setText("تعديل بيانات المنتجات");
    ...
    private void bt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_updateActionPerformed
        ...
        try {
            ...
            String sql22 = " select * from producer where producer_id= '" + tex_producer_id.getText() + "' AND producer_id !='" + producer_id + "'";
            ...
            sql22 = " select * from producer where producer_name= '" + tex_producer_name.getText() + "' AND producer_id !='" + producer_id + "'";
            pst = conn.prepareStatement(sql22);
            ...
            if (tex_producer_id.getText().isEmpty()) {
                ...
                int Ahmed = JOptionPane.showConfirmDialog(null, "هل تريد تعديل البيانات", "تعديل بيانات", JOptionPane.YES_NO_OPTION);
                if (Ahmed == 0) {

                    String[] updateFail = {"producer_id", "producer_name", "type_name", "company_make",
                        "country_make", "group_name", "section_name", "type_name1", "ref", "max", "max_buy", "max_sale",
                        "max_number", "min", "min_buy", "min_sale", "min_number", "producer_note", "alarm_number", "alarm_date",
                        "user_save", "end_date"};

                    String[] updatevalus = {tex_producer_id.getText(), tex_producer_name.getText(), tex_type_name.getText(),
                        ...
                        tex_alarm_date.getText(), username, null};

                    int res = db.update("producer", updateFail, updatevalus, new String[]{"producer_id"}, new String[]{tex_producer_id.getText()}, null, "=", "and");
            ...
            Logger.getLogger(Producer_Edit.class.getName()).log(Level.SEVERE, null, e);
        } finally {
            try {
                rs.close();
                pst.close();
    ...
    private void tex_country_makeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tex_country_makeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tex_country_makeActionPerformed

    private void tex_alarm_numberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tex_alarm_numberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tex_alarm_numberActionPerformed

    private void bt_exit3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_exit3ActionPerformed
        Producer_Edit.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Producer_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Producer_Edit().setVisible(true);
            }
        });
    }
